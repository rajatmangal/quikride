...
router.get('/post/create', authentication.checkAuthentication, (req, res)=>{
...
router.post('/post/create', authentication.checkAuthentication, async (req, res)=>{
    ...
    var post  = new postsModel({username: req.user.username, pickuplocation: req.body.pickUpLocation, dropofflocation:req.body.dropOffLocation, usermessage: req.body.description, ridecost: 0});
